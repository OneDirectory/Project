        ...
        <div id="wrapper">
            ...
            <div id="sidebar-wrapper">
                <ul class="sidebar-nav">
                    ...
                    <li><a href="#" onclick="toggle('briansQuery');">Total number of Failures per Model</a>
                    </li>
                    <li><a href="#" onclick="toggle('johnsQuery');">All IMSIs with Failed Call Data</a>
                    </li>
                    <li><a href="#" onclick="toggle('imsisForFailreClassDiv');">All IMSIs for a FailureClass</a>
                    </li>
                    <li class="sidebar-brand"><a href="CSRPage.jsp">Customer Service Rep Enq</a>
                    </li>
                    <li><a href="http://localhost:8080/project/LogoutServlet">Log out</a>
                    </li>
                </ul>
                <br>
            </div>
                            ...
                            <div class="transbox">
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="datetime-local" id='from' class="form-control" name="from" placeholder="yyyy-dd-mm hh:mm" autofocus>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="datetime-local" id='to' class="form-control" name="to" placeholder="yyyy-dd-mm hh:mm" autofocus>
                                        </div>
                                    </div>
                            ...
                            <div class="transbox">
                                ...
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        <label class="control-label col-sm-2" for="ID">From:</label>
                                        <div class="col-sm-5">
                                            <input type="datetime-local" id='IMSIFrom' class="form-control" name="from" placeholder="dd-mm-yyyy hh:mm" autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-sm-2" for="ID">To:</label>
                                        <div class="col-sm-5">
                                            <input type="datetime-local" id='IMSITo' class="form-control" name="to" placeholder="dd-mm-yyyy hh:mm" autofocus>
                                        </div>
                                    </div>
                                    <div class="col-sm-offset-4 col-sm-10">
                                        <br>
